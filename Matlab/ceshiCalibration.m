clear
load('3DtrainedNetresnet50-20.mat');%trainedNet1为resnet18模型，trainedNet3为resnet50模型
...
I=imresize(I,[1080, 1920]);%imresize(I,[1080, 1080]);
...
classes=["HLJW","HLJW1","hljd1","hljd2"];%["red", "blue","green","background"];
